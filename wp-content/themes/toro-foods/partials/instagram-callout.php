...
?>
<section class="instagram-callout">
    ...
    <div class="grid-box instagram-grid__callout">
        ...
        <img class="callout__separator" src="img/icons/separator.svg">
        <p class="callout__copy"><?php echo $callout_copy; ?></p>
    </div>
    ...
    <div class="grid-box grid-box--icon">
        <a class="grid__link" href=""><img class="instagram"></a>
    </div>
